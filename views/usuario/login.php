...
<div class="container"> 
  <div class="row">
    <div class="col s12">
      ...
      <h4 class="center">Escritório Virtual</h4>
      <p class="center"><span class="version"><?=VERSAO;?></span></p>
...
<div class="row">
  <div class="input-field col s12">
    <p class="center"><a href="<?php echo BASE_URL;?>arrecuperarsenha">Esqueci minha Senha</a></p>
