...
<?php endif;?>
<form method="post" class="col s12 formLogin" action="<?=BASE_URL;?>arrecuperarsenha/storageSenha">

<div class="row">
    <div class="col s12">
        <p>Olá <strong><?=$cliente['nome_cliente'];?></strong>,<br>Abaixo digite a nova senha:</p>
...
<div class="row">
  <div class="input-field col s12">
      <input type="hidden" value="<?=md5($cliente['id_cliente']);?>" name="id">
