...
<div class="row">
    ...
    <?php endif; ?>
    <form action="<?= BASE_URL; ?>painelcadastros/storageCliente" method="post" class="col s12">
        <div class="row">
            ...
            <div class="input-field col s6">
                <input type="tel" name="cpf" id="cpf" value="<?= $cliente['cpf']; ?>" readonly>
        ...
        <div class="row">
            <div class="input-field col s3">
                <input type="tel" name="cartao_sus" id="cartao_sus" value="<?= $cliente['rg']; ?>">
                <label for="cartao_sus">RG:</label>
            </div>
            <div class="input-field col s3">
        ...
        <div class="row">
            ...
            <div class="col s3">
                ...
                <select name="estado_civil" id="estado_civil" class="browser-default">
                    ...
                    <option value="<?= $estadoCivil['nome']; ?>"
                        <?= $cliente['marital_status'] == $estadoCivil['nome'] ? 'selected' : ''; ?>>
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
                <input type="text" name="logradouro" id="logradouro"
                    value="<?= $cliente['address']['logradouro'] ?? ''; ?>">
            ...
            <div class="input-field col s3">
                <input type="text" name="complemento" id="complemento"
                    value="<?= $cliente['address']['complemento'] ?? ''; ?>">
            ...
            <div class="col s3">
                ...
                <select name="estado" id="estado" class="browser-default">
                    ...
                    <option value="<?= $estado['Uf']; ?>"
                        <?= isset($cliente['address']['estado']) && $cliente['address']['estado'] == $estado['Uf'] ? 'selected' : ''; ?>>
                        <?= $estado['Nome']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
    ...
    <div class="row">
        <form class="col s12" method="post" enctype="multipart/form-data"
            action="<?= BASE_URL; ?>painelcadastros/storageDocumentos">
            <div class="row">
