        ...
        <table class="striped">
            ...
            <?php foreach($boletos as $boleto):?>
                <tr>
                    ...
                    <td>
                        <?=isset($boleto['cliente']['nome_cliente'])?$boleto['cliente']['id_cliente'].' - '.$boleto['cliente']['nome_cliente']:'-';?>
                    </td>
                    <td>
...
<div class="row">
    <div class="col s12">
        <ul class="pagination">
            ...
            <li class="active"><a href="<?php echo BASE_URL;?>painelboletos?p=<?php echo $q;?>"><strong><?php echo $q;?></strong></a></li>
            <?php else: ?>	
            <li class="waves-effect"><a href="<?php echo BASE_URL;?>painelboletos?p=<?php echo $q;?>"><?php echo $q;?></a></li>
            <?php endif;?>
            <?php endfor;?>	
        </ul>
    </div>
